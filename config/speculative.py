...
class SpeculativeConfig:
    ...
    # kyleryu 
    # CTC pointer decoding configuration
    # pass
    # ctc_max_concat_length: int | None = Field(default=None, ge=1)
    # """Maximum length of CTC text to concatenate with prompt for verification.
    # If None, no limit is applied."""
    # ctc_enable_pointer: bool = False
    # """Enable pointer-based CTC decoding where a pointer tracks the current
    # position in the CTC text. If accepted, pointer advances; otherwise, stays."""
    ...
    # kyleryu 
    def _validate_ctc(self):
        # if self.ctc_max_concat_length is None:
        #     # Set default if not provided
        #     self.ctc_max_concat_length = 1000  # Arbitrary default
        # if self.ctc_max_concat_length < 1:
        #     raise ValueError(
        #         f"ctc_max_concat_length={self.ctc_max_concat_length} must be >= 1"
        #     )
        # # Enable pointer by default for this method
        # self.ctc_enable_pointer = True
        pass
